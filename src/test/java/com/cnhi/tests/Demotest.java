...
//		jobCardPage.clickOnBreakdownOrRemoteAppointmentCheckBox();
		...
		CustomerName="Customer VALID2022/04/06 19:47:41";
//		jobCardPage.enterCustomerNameOnCustomerNameTextBox(CustomerName, device);
//		jobCardPage.enterEmailOnCustomerEmailTextBox("customer.valid@cnhi.com");
//		jobCardPage.enterPhoneNoOnCustomerPhoneTextBox("0634353637");
//		jobCardPage.enterContactNoOnContactPhoneTextBox("0745464748");
...
//		jobCardPage.clickOnYesButton();
		...
		aMob.AssertTrue(mileageTachoPage.isSubmitBtnVisible(), "Submit Button Visible Successfully");
		aMob.AssertTrue(mileageTachoPage.isCancelBtnVisible(), "Cancel Button Visible Successfully");
	...
	public void Test5() throws Exception {
		...
		aMob.AssertTrue(mileageTachoPage.isCancelBtnVisible(), "Cancel Button Visible Successfully");
		mileageTachoPage.enterCustomerNameTextBox("Customer VALID");
		mileageTachoPage.turnOffTermConditionRadioButton();
		aMob.AssertEquals(mileageTachoPage.getSubmitBtnEnableStatus(), "false",
		...
		mileageTachoPage.turnOnTermConditionRadioButton();
		aMob.AssertEquals(mileageTachoPage.getSubmitBtnEnableStatus(), "true",
				"The Submit Button Is Enabled After Check Term And Condition And Entering Signature");
		mileageTachoPage.clickOnCancelBtn();
		mileageTachoPage.clickOnCheckinIcon();
		aMob.AssertTrue(mileageTachoPage.getTermConditionRadioButtonStatus().equalsIgnoreCase("1"),
				"Term Condition Radio Button Is Checked");
		mileageTachoPage.turnOnCustomerNotPresentRadioButton();
		aMob.AssertEquals(mileageTachoPage.getSubmitBtnEnableStatus(), "true",
		...
		mileageTachoPage.turnOnPrivacyNoticeRadioButton();
		mileageTachoPage.clickOnCancelBtn();
		mileageTachoPage.clickOnCheckinIcon();
		aMob.AssertTrue(mileageTachoPage.getTermConditionRadioButtonStatus().equalsIgnoreCase("1"),
				"Term Condition Radio Button Is Checked");
		aMob.AssertTrue(mileageTachoPage.getPrivacyNoticeRadioButtonStatus().equalsIgnoreCase("1"),
